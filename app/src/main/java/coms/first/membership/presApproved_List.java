...
public class presApproved_List extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pres_approved__list); this.setTitle("Approved Requests");

        lv=(ListView) findViewById(R.id.LV);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("users");

        Query query = databaseReference.orderByChild("status_member").equalTo("Completed_0");
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position,
                                    long id) {
                Intent DeleteUpdate=  new Intent(presApproved_List.this, approved_list_details.class);
